...
namespace ML
{
    public partial class Model2
    {
        ...
        #endregion
        */
        private static string MLNetModelPath = Path.GetFullPath("Model2.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Tags");
            if (labelColumn == null)
            {
                throw new Exception("Tags column not found. Make sure the name searched for matches the name in the schema.");
            }
